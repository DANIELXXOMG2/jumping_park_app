...
- `#540` — `sdd/comprehensive-product-audit-and-roadmap/design` explicitly chose to ship additive hardening on the existing “Next.js App Router + service-layer + Firebase Admin stack” instead of rewriting the product architecture.
