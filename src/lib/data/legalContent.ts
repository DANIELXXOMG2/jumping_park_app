...
export const DEFAULT_CONSENT_CONTENT: ConsentContentStructure = {
  ...
  consent: {
    title: "Consentimiento Informado para la Práctica de Actividades Deportivas",
    subtitle: "Es una actividad deportiva que puede ocasionar lesiones leves o importantes",
    introduction:
