...
import { minorSchema, type Minor } from "@/lib/schemas/consent.schema";
        ...
        <div className="flex items-center justify-between px-4 py-3 bg-gray-800/80 border-b border-gray-700 sticky top-0 z-10">
          <div className="flex items-center gap-2">
            ...
            <span className="text-sm font-semibold text-white">
              {initialData ? `Editar Menor #${minorNumber}` : `Agregar Menor #${minorNumber}`}
            </span>
          </div>
          <button
            type="button"
        ...
        >
          <div className="p-4 space-y-4">
            ...
            <div className="grid grid-cols-2 gap-3">
              <div>
                <label className="flex items-center gap-1 text-xs text-gray-400 mb-1.5">
                  <User size={12} />
                  Nombre *
                </label>
                <input
