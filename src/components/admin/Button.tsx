...
const variantStyles = {
	primary:
		"bg-gradient-to-r from-primary to-primary-contrast text-background font-semibold hover:opacity-90",
	secondary:
	...
	ghost:
		"bg-transparent text-foreground/70 hover:bg-surface-muted hover:text-foreground",
	danger:
