    ...
    <div className="min-h-screen bg-linear-to-br from-gray-900 via-black to-gray-900 flex flex-col items-center justify-center p-6">
      ...
      <div className="text-center max-w-md">
        ...
        <p className="text-gray-400 text-lg mb-6">
          Gracias por completar el registro, <span className="text-neon-blue font-semibold">{nombre}</span>
        </p>

        {/* Número de consecutivo */}
        <div className="bg-gray-800/50 border border-gray-700 rounded-2xl p-6 mb-8">
          <p className="text-gray-400 text-sm uppercase tracking-wider mb-2">Tu número de registro</p>
        ...
        <p className="text-gray-600 text-sm mt-4">
          Regresando automáticamente en <span className="text-gray-400 font-mono">{countdown}s</span>
        </p>
      </div>
